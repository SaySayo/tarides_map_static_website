# 1 "duniverse/sexplib/src/lexer.mll"
...
# 83 "duniverse/sexplib/src/lexer.ml"
...
and __ocaml_lex_main_rec buf lexbuf __ocaml_lex_state =
  match Lexing.engine __ocaml_lex_tables __ocaml_lex_state lexbuf with
      | 0 ->
# 94 "duniverse/sexplib/src/lexer.mll"
                     ( found_newline lexbuf 0;
                       main buf lexbuf )
# 369 "duniverse/sexplib/src/lexer.ml"

  | 1 ->
# 96 "duniverse/sexplib/src/lexer.mll"
           ( main buf lexbuf )
# 374 "duniverse/sexplib/src/lexer.ml"

  | 2 ->
let
# 97 "duniverse/sexplib/src/lexer.mll"
                          text
# 380 "duniverse/sexplib/src/lexer.ml"
= Lexing.sub_lexeme lexbuf lexbuf.Lexing.lex_start_pos lexbuf.Lexing.lex_curr_pos in
# 97 "duniverse/sexplib/src/lexer.mll"
                               ( Token.comment text ~main buf lexbuf )
# 384 "duniverse/sexplib/src/lexer.ml"

  | 3 ->
# 98 "duniverse/sexplib/src/lexer.mll"
        ( Token.lparen )
# 389 "duniverse/sexplib/src/lexer.ml"

  | 4 ->
# 99 "duniverse/sexplib/src/lexer.mll"
        ( Token.rparen )
# 394 "duniverse/sexplib/src/lexer.ml"

  | 5 ->
# 101 "duniverse/sexplib/src/lexer.mll"
      (
...
# 406 "duniverse/sexplib/src/lexer.ml"

  | 6 ->
# 109 "duniverse/sexplib/src/lexer.mll"
         ( Token.hash_semi )
# 411 "duniverse/sexplib/src/lexer.ml"

  | 7 ->
# 111 "duniverse/sexplib/src/lexer.mll"
      (
        let pos = Lexing.lexeme_start_p lexbuf in
        Quoted_string_buffer.add_lexeme buf lexbuf;
...
# 423 "duniverse/sexplib/src/lexer.ml"

  | 8 ->
# 119 "duniverse/sexplib/src/lexer.mll"
         ( main_failure lexbuf "illegal end of comment" )
# 428 "duniverse/sexplib/src/lexer.ml"

  | 9 ->
# 125 "duniverse/sexplib/src/lexer.mll"
      ( main_failure lexbuf "comment tokens in unquoted atom" )
# 433 "duniverse/sexplib/src/lexer.ml"

  | 10 ->
let
# 126 "duniverse/sexplib/src/lexer.mll"
                                            str
# 439 "duniverse/sexplib/src/lexer.ml"
= Lexing.sub_lexeme lexbuf lexbuf.Lexing.lex_start_pos lexbuf.Lexing.lex_curr_pos in
# 126 "duniverse/sexplib/src/lexer.mll"
                                                ( Token.simple_string str )
# 443 "duniverse/sexplib/src/lexer.ml"

  | 11 ->
# 127 "duniverse/sexplib/src/lexer.mll"
        ( Token.eof )
# 448 "duniverse/sexplib/src/lexer.ml"
...
and __ocaml_lex_scan_string_rec buf start lexbuf __ocaml_lex_state =
  match Lexing.engine __ocaml_lex_tables __ocaml_lex_state lexbuf with
      | 0 ->
# 130 "duniverse/sexplib/src/lexer.mll"
        ( Quoted_string_buffer.add_lexeme buf lexbuf; () )
# 460 "duniverse/sexplib/src/lexer.ml"

  | 1 ->
# 132 "duniverse/sexplib/src/lexer.mll"
      (
...
# 470 "duniverse/sexplib/src/lexer.ml"

  | 2 ->
# 139 "duniverse/sexplib/src/lexer.mll"
      (
...
# 480 "duniverse/sexplib/src/lexer.ml"

  | 3 ->
let
# 145 "duniverse/sexplib/src/lexer.mll"
                                                 c
# 486 "duniverse/sexplib/src/lexer.ml"
= Lexing.sub_lexeme_char lexbuf (lexbuf.Lexing.lex_start_pos + 1) in
# 146 "duniverse/sexplib/src/lexer.mll"
      (
        Quoted_string_buffer.add_char buf (char_for_backslash c);
        Quoted_string_buffer.add_lexeme buf lexbuf;
        scan_string buf start lexbuf
      )
# 494 "duniverse/sexplib/src/lexer.ml"

  | 4 ->
let
# 151 "duniverse/sexplib/src/lexer.mll"
                   c1
# 500 "duniverse/sexplib/src/lexer.ml"
= Lexing.sub_lexeme_char lexbuf (lexbuf.Lexing.lex_start_pos + 1)
and
# 151 "duniverse/sexplib/src/lexer.mll"
                                 c2
# 505 "duniverse/sexplib/src/lexer.ml"
= Lexing.sub_lexeme_char lexbuf (lexbuf.Lexing.lex_start_pos + 2)
and
# 151 "duniverse/sexplib/src/lexer.mll"
                                               c3
# 510 "duniverse/sexplib/src/lexer.ml"
= Lexing.sub_lexeme_char lexbuf (lexbuf.Lexing.lex_start_pos + 3) in
# 152 "duniverse/sexplib/src/lexer.mll"
      (
...
# 528 "duniverse/sexplib/src/lexer.ml"

  | 5 ->
let
# 167 "duniverse/sexplib/src/lexer.mll"
                          c1
# 534 "duniverse/sexplib/src/lexer.ml"
= Lexing.sub_lexeme_char lexbuf (lexbuf.Lexing.lex_start_pos + 2)
and
# 167 "duniverse/sexplib/src/lexer.mll"
                                           c2
# 539 "duniverse/sexplib/src/lexer.ml"
= Lexing.sub_lexeme_char lexbuf (lexbuf.Lexing.lex_start_pos + 3) in
# 168 "duniverse/sexplib/src/lexer.mll"
      (
...
# 548 "duniverse/sexplib/src/lexer.ml"

  | 6 ->
let
# 174 "duniverse/sexplib/src/lexer.mll"
               c
# 554 "duniverse/sexplib/src/lexer.ml"
= Lexing.sub_lexeme_char lexbuf (lexbuf.Lexing.lex_start_pos + 1) in
# 175 "duniverse/sexplib/src/lexer.mll"
      (
...
# 563 "duniverse/sexplib/src/lexer.ml"

  | 7 ->
# 182 "duniverse/sexplib/src/lexer.mll"
      (
        found_newline lexbuf 0;
...
# 573 "duniverse/sexplib/src/lexer.ml"

  | 8 ->
# 189 "duniverse/sexplib/src/lexer.mll"
      (
...
# 584 "duniverse/sexplib/src/lexer.ml"

  | 9 ->
# 197 "duniverse/sexplib/src/lexer.mll"
      (
        let msg =
          sprintf
...
# 596 "duniverse/sexplib/src/lexer.ml"
...
and __ocaml_lex_scan_block_comment_rec buf locs lexbuf __ocaml_lex_state =
  match Lexing.engine __ocaml_lex_tables __ocaml_lex_state lexbuf with
      | 0 ->
# 208 "duniverse/sexplib/src/lexer.mll"
      ( Quoted_string_buffer.add_lexeme buf lexbuf;
        found_newline lexbuf 0; scan_block_comment buf locs lexbuf )
# 609 "duniverse/sexplib/src/lexer.ml"

  | 1 ->
# 211 "duniverse/sexplib/src/lexer.mll"
      ( Quoted_string_buffer.add_lexeme buf lexbuf;
        scan_block_comment buf locs lexbuf )
# 615 "duniverse/sexplib/src/lexer.ml"

  | 2 ->
# 214 "duniverse/sexplib/src/lexer.mll"
      (
        Quoted_string_buffer.add_lexeme buf lexbuf;
...
# 626 "duniverse/sexplib/src/lexer.ml"

  | 3 ->
# 222 "duniverse/sexplib/src/lexer.mll"
    (
      Quoted_string_buffer.add_lexeme buf lexbuf;
      let cur = lexeme_end_p lexbuf in
...
# 636 "duniverse/sexplib/src/lexer.ml"

  | 4 ->
# 229 "duniverse/sexplib/src/lexer.mll"
      (
        Quoted_string_buffer.add_lexeme buf lexbuf;
        match locs with
...
# 647 "duniverse/sexplib/src/lexer.ml"

  | 5 ->
# 237 "duniverse/sexplib/src/lexer.mll"
      (
        match locs with
        | [] -> assert false
...
# 662 "duniverse/sexplib/src/lexer.ml"
...
# 249 "duniverse/sexplib/src/lexer.mll"
...
# 744 "duniverse/sexplib/src/lexer.ml"
