...
; (fun __caml_parser_env ->
    ...
    let _4 = (Parsing.peek_val __caml_parser_env 0 : string) in
    Obj.repr(
# 44 "duniverse/ocaml-cohttp/cohttp/src/accept_parser.mly"
                     (
...
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 55 "duniverse/ocaml-cohttp/cohttp/src/accept_parser.mly"
                         (
...
; (fun __caml_parser_env ->
    ...
    let _4 = (Parsing.peek_val __caml_parser_env 0 : 'params) in
    Obj.repr(
# 58 "duniverse/ocaml-cohttp/cohttp/src/accept_parser.mly"
                        (
...
; (fun __caml_parser_env ->
    ...
    let _4 = (Parsing.peek_val __caml_parser_env 0 : 'params) in
    Obj.repr(
# 61 "duniverse/ocaml-cohttp/cohttp/src/accept_parser.mly"
                       (
...
; (fun __caml_parser_env ->
    ...
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'params) in
    Obj.repr(
# 79 "duniverse/ocaml-cohttp/cohttp/src/accept_parser.mly"
             (
...
; (fun __caml_parser_env ->
    ...
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'params) in
    Obj.repr(
# 96 "duniverse/ocaml-cohttp/cohttp/src/accept_parser.mly"
             (
